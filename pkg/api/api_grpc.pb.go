...
func (c *aPIServiceClient) Reroll(ctx context.Context, in *RerollRequest, opts ...grpc.CallOption) (*RerollResponse, error) {
	out := new(RerollResponse)
	err := c.cc.Invoke(ctx, APIService_Reroll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIServiceClient) Variation(ctx context.Context, in *VariationRequest, opts ...grpc.CallOption) (*VariationResponse, error) {
	out := new(VariationResponse)
	err := c.cc.Invoke(ctx, APIService_Variation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAPIServiceServer) Reroll(context.Context, *RerollRequest) (*RerollResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Reroll not implemented")
}
func (UnimplementedAPIServiceServer) Variation(context.Context, *VariationRequest) (*VariationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Variation not implemented")
}
...
func _APIService_Reroll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RerollRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServiceServer).Reroll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: APIService_Reroll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServiceServer).Reroll(ctx, req.(*RerollRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _APIService_Variation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VariationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServiceServer).Variation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: APIService_Variation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServiceServer).Variation(ctx, req.(*VariationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
